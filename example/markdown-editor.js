...
var bootstrapMarkdown = {
    ...
    getConfig : function( $htmlText , opt  ){
        ...
        var config = {
            ...
            // onShow : function( md ){
            //     md.$textarea.siblings('.md-header').find('button').each( function( index , button ){
            ...
            additionalButtons : [
                [{
                    ...
                    data: [{
                        ...
                        toggle: true, // this param only take effect if you load bootstrap.js
                        title: "help",
                        icon: { 'glyph' : "glyphicon glyphicon-question-sign" } ,
                        callback: function(e){
                            // Replace selection with some drinks
                            window.open('http://www.appinn.com/markdown/','_blank');
                        }
                    }]
                }]
            ]
